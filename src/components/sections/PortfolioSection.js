...
export default function PortfolioSection({ projectsData }) {
  return (
    ...
    >
      ...
      <div
        className={`bg-[#00052B] pt-10 flex flex-col-reverse justify-between items-start md:grid md:grid-cols-2 gap-20 md:pt-52`}
      >
        <div
      ...
      <div
        className={`bg-[#310721] pt-10 flex flex-col-reverse justify-between items-start md:grid md:grid-cols-2 gap-20 md:pt-52`}
      >
        <div
          className={`hidden bg-[url('/assets/mockups/obenify.jpg')] bg-cover bg-no-repeat shadow-[36px_-20px_66px_-4px_rgba(0,0,0,0.37)] w-full h-[420px] rounded-tr-[40px] md:flex`}
        ></div>
      ...
      <div
        className={`bg-[#1F4609] pt-10 flex flex-col-reverse justify-between items-start md:grid md:grid-cols-2 gap-20 md:pt-52`}
      >
        <div
          className={`hidden bg-[url('/assets/mockups/obenify.jpg')] bg-cover bg-no-repeat shadow-[36px_-20px_66px_-4px_rgba(0,0,0,0.37)] w-full h-[420px] rounded-tr-[40px] md:flex`}
        ></div>
